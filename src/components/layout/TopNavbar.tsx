...
import {
    LayoutDashboard, Users, FileText, CheckCircle, Wallet,
    FileCheck, PieChart, ShieldAlert, Shield, LogOut,
    Menu, X, Bell, User as UserIcon, ChevronDown
} from "lucide-react";
...
export default function TopNavbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 h-16 bg-slate-950 border-b border-slate-800 z-50 flex items-center justify-between px-4 md:px-6 shadow-sm">
            {/* 1. Branding */}
